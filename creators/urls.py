...
from .views import (
    ...
    creator_social_media_refresh,
    creator_social_media_ai_status,
    creator_support,
    creator_marketplace,
    creator_requests,
...
urlpatterns = [
    ...
    path('social-media/refresh/', creator_social_media_refresh, name='creator_social_media_refresh'),
    path('social-media/ai-status/', creator_social_media_ai_status, name='creator_social_media_ai_status'),
