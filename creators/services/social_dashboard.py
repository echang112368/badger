...
class InstagramAnalyticsService:
    ...
    def fetch_and_cache(
        ...
        # Carry async status forward so it survives the payload overwrite below.
        old_payload = (snapshot.payload or {}) if snapshot else {}
        old_ai_cache = old_payload.get("_ai_cache")
        old_sync_status = old_payload.get("_sync_status")
        ...
        if old_sync_status:
            payload["_sync_status"] = old_sync_status
